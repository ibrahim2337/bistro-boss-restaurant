...
const PopularMenu = () => {
  ...
  return (
    <div className="container mx-auto px-5 lg:px-20">
      ...
      <button className=" px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform  rounded-lg bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 ">View Full  Menu</button>
    </div>
  );
};
